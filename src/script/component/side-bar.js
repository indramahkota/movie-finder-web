...
class SideBar extends HTMLElement {
  ...
  render() {
    ...
    this._target1 = this.shadowDOM.querySelector("#target1");
    this._target2 = this.shadowDOM.querySelector("#target2");
    this._target3 = this.shadowDOM.querySelector("#target3");
    this._target4 = this.shadowDOM.querySelector("#target4");
